    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            AppButtons.socialMediaButton(onTap: onTapGoogle,svgIconPath: AppSvgIcons.facebook),
            12.horizontalSpace,
            AppButtons.socialMediaButton(onTap: onTapFacebook,svgIconPath: AppSvgIcons.google),
          ],
        ),
